...
class VGG13:
    def __init__(self, dataset_name):
        ...
        self.vgg_layers = [
            ...
            layers.Dense(self.output_size, activation=None)
        ]
        ...
        if self.dataset_name == "MNIST":
            ...
            self.optimizer = tf.keras.optimizers.SGD(learning_rate=0.1, decay=0.005, momentum=0.0, nesterov=False)
            # self.optimizer = tf.keras.optimizers.SGD(learning_rate=0.1, decay=0, momentum=0.0, nesterov=False)
            # self.optimizer = tf.keras.optimizers.SGD(learning_rate=0.1, decay=0.05, momentum=0.0, nesterov=False)
            # self.optimizer = tf.keras.optimizers.SGD(learning_rate=0.1, decay=0.001, momentum=0.5, nesterov=True)
